...
configureRouter.put("/api/configurelaptop/:id",configurationController.updateConfiguration)
configureRouter.delete("/api/configurelaptop/:id",configurationController.deleteConfiguration)
